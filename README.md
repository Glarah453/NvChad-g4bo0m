...
# 📋 **Requisitos de Instalación en Linux/Unix**.
...
Instalación de [Python](), [NodeJs](), [Npm](), [GCC](), [G++](), [Ripgrep]() y [Make]():
...
### 2. Correr `:MasonInstallAll` comando después de [lazy.nvim]() termina de descargar plugins.
...
- Correr `:MasonInstallAll` comando después de [lazy.nvim]() termina de descargar plugins.
